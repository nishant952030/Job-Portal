...
import { alreadyApplied, apply_for_job, get_all_applied_jobs, getApplicants, updateUser } from "../controllers/application.js";
...
router.get("/applied/:id", isAuthenticated, alreadyApplied);
